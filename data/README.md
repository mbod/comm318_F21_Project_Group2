...
This folder contain the data files we have used in our analysis, separated into two subfolders - "Raw", which contains all the original, unedited data, and "Clean", which contains all the data after it has been edited for clarity of analysis. 
